...
namespace MobileHR.Services
{
    public class MockDataStore : IDataStore<Item>
    {
        ...
        public Task<IEnumerable<Item>> GetSortedAscItemsAsync(bool forceRefresh = false)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Item>> GetSortedDescItemsAsync(bool forceRefresh = false)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<Item>> SearchItemsAsync(string text, bool forceRefresh = false)
        {
            throw new NotImplementedException();
        }
    }
